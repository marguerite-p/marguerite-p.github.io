...
![Coffin Rock portrait](/assets/images/mode/coffin-rock-1)
...
![lingettes démaquillantes cercueil](/assets/images/mode/coffin-rock-2)
...
<div class="has-text-centered"><h3>Et vous, tentez-vous de réduire vos déchets ? <span>Vous arrive-t-il de consommer en vrac ? A bientôt pour de nouvelles interviews :smiley:</h3></div>
